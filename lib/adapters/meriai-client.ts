...
export class MeriAiClient {
  ...
  ready(): Promise<MeriAiReady> { return this.fetchClient.request("/readyz", { parse: parseReady }); }
  ...
  services(): Promise<MeriAiService[]> { return this.fetchClient.request("/api/services", { parse: parseServices }); }
